...
func (x *WeatherResponce) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WeatherResponce) ProtoMessage() {}

func (x *WeatherResponce) ProtoReflect() protoreflect.Message {
	mi := &file_weather_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WeatherResponce.ProtoReflect.Descriptor instead.
func (*WeatherResponce) Descriptor() ([]byte, []int) {
	return file_weather_proto_rawDescGZIP(), []int{1}
}

func (x *WeatherResponce) GetLocation() string {
	if x != nil {
		return x.Location
	}
	return ""
...
func (x *WeatherResponce) GetDescription() string {
	if x != nil {
...
func (x *WeatherResponce) GetTemperatura() float32 {
	if x != nil {
...
func (x *WeatherResponce) GetHumidity() float32 {
	if x != nil {
		return x.Humidity
	}
	return 0
...
func (x *WeatherResponce) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_weather_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xab, 0x01,
	0x0a, 0x0f, 0x57, 0x65, 0x61, 0x74, 0x68, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63,
	...
	,
...
var file_weather_proto_goTypes = []any{
	...
	(*WeatherResponce)(nil), // 1: WeatherResponce
}
var file_weather_proto_depIdxs = []int32{
	0, // 0: WeatherService.GetWeatherUpdates:input_type -> WeatherRequest
	1, // 1: WeatherService.GetWeatherUpdates:output_type -> WeatherResponce
